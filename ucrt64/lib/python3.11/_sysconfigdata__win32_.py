...
build_time_vars = {'ABI3DLLLIBRARY': 'libpython3.dll',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/ucrt64/bin',
 'BINLIBDEST': '/ucrt64/lib/python3.11',
 ...
 'CC': 'gcc',
 'CCSHARED': '',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf -mtune=generic '
 ...
 'CONFIG_ARGS': "'--prefix=/ucrt64' '--host=x86_64-w64-mingw32' "
                ...
                "'LDFLAGS=' 'CPPFLAGS=-D__USE_MINGW_ANSI_STDIO=1'",
 'CONFINCLUDEDIR': '/ucrt64/include',
 'CONFINCLUDEPY': '/ucrt64/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/c/M/B/src/build-UCRT64/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/c/M/B/src/build-UCRT64/lcov-report',
 ...
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': '/ucrt64 /ucrt64/lib /ucrt64/lib/python3.11 '
             '/ucrt64/lib/python3.11/lib-dynload',
 'DESTLIB': '/ucrt64/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/ucrt64/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/ucrt64/include /ucrt64/include /ucrt64/include/python3.11 '
                   '/ucrt64/include/python3.11',
 'INCLUDEDIR': '/ucrt64/include',
 'INCLUDEPY': '/ucrt64/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/ucrt64/lib/python3.11',
 'LIBDIR': '/ucrt64/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf '
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -DNDEBUG -g '
                    '-fwrapv -O3 -Wall -march=nocona -msahf -mtune=generic -O2 '
                    '-pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong '
                    '-O3 -march=nocona -msahf -mtune=generic -O2 -pipe '
                    '-Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -O3 '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/ucrt64/lib/pkgconfig',
 'LIBPL': '/ucrt64/lib/python3.11/config-3.11',
 ...
 'MACHDESTLIB': '/ucrt64/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Python-3.11.9/Modules/makesetup',
 'MANDIR': '/ucrt64/share/man',
 ...
 'NCURSESW_INCLUDEDIR': 'D:/a/msys64/ucrt64/include/ncursesw',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona '
                             '-msahf -mtune=generic -O2 -pipe '
                             '-Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong '
                             '-O3 -march=nocona -msahf -mtune=generic -O2 '
 ...
 'PY_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf '
              '-mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
              '-fstack-protector-strong -O3 -march=nocona -msahf '
              '-mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
              '-fstack-protector-strong -O3',
 ...
 'PY_CORE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf '
                   '-mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
                   '-fstack-protector-strong -O3 -march=nocona -msahf '
                   '-mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
                   '-fstack-protector-strong -O3 -fno-semantic-interposition '
 ...
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf '
                        '-mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
                        '-fstack-protector-strong -O3 -march=nocona -msahf '
                        '-mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
                        '-fstack-protector-strong -O3 '
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/ucrt64/share/zoneinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': '../Python-3.11.9/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 0,
 'VENVLAUNCHERDIR': '/ucrt64/lib/python3.11/venv/scripts/nt',
 'VERSION': '3.11',
 'VPATH': '../Python-3.11.9',
 'WASM_ASSETS_DIR': './ucrt64',
 'WASM_STDLIB': './ucrt64/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 'WINDRES': 'windres',
 ...
 'abs_builddir': 'C:/M/B/src/build-UCRT64',
 'abs_builddir_b2h': 'C:/M/B/src/build-UCRT64',
 'abs_srcdir': 'C:/M/B/src/Python-3.11.9',
 'abs_srcdir_b2h': 'C:/M/B/src/Python-3.11.9',
 'datarootdir': '/ucrt64/share',
 'exec_prefix': '/ucrt64',
 'prefix': 'D:/a/msys64/ucrt64',
 'prefix_b2h': 'D:/a/msys64/ucrt64',
